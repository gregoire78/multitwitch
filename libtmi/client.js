        ...
        switch(message.command) {
            ...
            case "USERSTATE":
                ...
                if (message.tags["emote-sets"] !== this.emotes) {
                    this._updateEmoteset(message.tags["emote-sets"].replace(",1508783069", ""));
                }
...
client.prototype._updateEmoteset = async function _updateEmoteset(sets) {
    ...
    const response = await fetch(`https://api.twitch.tv/kraken/chat/emoticon_images?emotesets=${sets}`,{
        method: 'GET',
        headers: new Headers({
    ...
    this.emotesets = json["emoticon_sets"] || {};
